...
OpenAI has not yet released an official API for ChatGPT, but there are several community-created libraries available. Check out our list of [ChatGPT API](https://lablab.ai/tech/chatgpt#api) libraries on the [OpenAI ChatGPT technology page](https://lablab.ai/tech/chatgpt) for more information.
