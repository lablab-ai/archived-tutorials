...
description: "In this tutorial I will show you how to create a stable diffusion API on a GCP VM instance in few minutes"
image: "https://storage.googleapis.com/lablab-static-eu/images/tutorials/stable_diffusion_api_gcp.webp"
