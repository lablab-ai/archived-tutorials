...
description: "Generate variations on an input image using a fine-tuned version of Stable Diffusion"
image: "https://storage.googleapis.com/lablab-static-eu/images/tutorials/stable_diffusion_image_variations.png"
