...
<Img
  src="https://storage.googleapis.com/lablab-static-eu/images/tutorials/file_str.png"
  caption="My file structure"
/>

And the configuration file (data.yaml) looks like this:

<Img
  src="https://storage.googleapis.com/lablab-static-eu/images/tutorials/datayaml.png"
  caption="Configuration file - data.yaml"
/>
...
**Thank you!** - [Jakub Misiło](https://www.linkedin.com/in/jmisilo/), Data Science Internn in [New Native](https://newnative.ai/)
