...
In this tutorial I will show you how to create a video from text prompts to complement a music and create a music video, such as this [one](https://www.youtube.com/watch?v=bspwTALOBws) or this [one](https://www.youtube.com/watch?v=bspwTALOBws). Everything using Stable Diffusion Deforum Google Colab notebook.
...
And if you can’t find a tool to create a certain thing, why not create it? Maybe during the upcoming [Stable Diffusion Hackathon](https://lablab.ai/event/stable-diffusion-ai-hackathon)? Today we are building better tomorrow, so we encourage you to be a part of the solution!
